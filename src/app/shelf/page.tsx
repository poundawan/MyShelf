  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <div className="text-xs font-bold uppercase tracking-widest text-gold">Ton étagère</div>
          <h1 className="mt-1 font-display text-3xl text-cream sm:text-4xl">Ma ludothèque</h1>
      ...
      {copies.length === 0 ? (
        <Card className="mt-8 p-10 text-center text-ink-soft">
          Ta ludothèque est vide. <Link href="/shelf/new" className="font-bold text-gold hover:underline">Ajoute ton premier jeu</Link>.
        </Card>
      ) : (
